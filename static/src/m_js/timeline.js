        ...
        success: function (data) {
           ...
           // 填充主体部分
            for (var d in usagelist){
                ...
                var sortId = usagelist[d].sort_id;
                //console.log(sortId)
                if (d%2==0)
                {
                var str = "<li> <div class='timeline-badge secondary'><i class='flaticon-message'></i></div> <div class='timeline-panel'> <div class='timeline-heading'> <h4 class='timeline-title'>"+usagelist[d].title+"</h4> <p><small class='text-muted'><i class='flaticon-message'></i> "+usagelist[d].keyword+"</small></p> </div> <div class='timeline-body'> <p>"+usagelist[d].content.substring(0,100)+"</p> </div> </div> </li>"
                }
                else{
                var str = "<li  class='timeline-inverted'> <div class='timeline-badge info'><i class='flaticon-price-tag'></i></div> <div class='timeline-panel'> <div class='timeline-heading'> <h4 class='timeline-title'>"+usagelist[d].title+"</h4> <p><small class='text-muted'><i class='flaticon-message'></i> "+usagelist[d].keyword+"</small></p> </div> <div class='timeline-body'> <p>"+usagelist[d].content.substring(0,100)+"</p> </div> </div> </li>"
